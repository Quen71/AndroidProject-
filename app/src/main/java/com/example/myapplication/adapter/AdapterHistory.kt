...
class AdapterHistory(private val deviceList: Array<SettingsItem>, private val onClick: ((selectedDevice: SettingsItem) -> Unit)? = null) : RecyclerView.Adapter<AdapterHistory.ViewHolder>() {
